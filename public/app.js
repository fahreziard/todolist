function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", {
    className: "m-5 text-4xl font-bold text-white "
  }, "Todos."), /*#__PURE__*/React.createElement("form", {
    className: "flex mb-2 justify-center w-full",
  ...
  }, "Batal")), message && /*#__PURE__*/React.createElement("span", {
    className: "text-red-600 text-sm mt-3 font-semibold"
  }, message))), todos.length > 0 ? /*#__PURE__*/React.createElement("ul", {
    className: "bg-slate-100 h-1/3 w-[320px] rounded-md shadow block mt-4 mx-auto divide-y divide-gray-300"
  }, todos.map(todo => {
    return /*#__PURE__*/React.createElement("li", {
      ...
      className: `flex-grow ${todo.done ? 'line-through opacity-80' : ''}`
    ...
    className: "text-slate-700 text-sm opacity-80"
  }, "Tidak ada Todo untuk saat ini")));
}
